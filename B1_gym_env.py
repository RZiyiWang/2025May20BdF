...
from B1_market_env import B1MarketEnv
from reward_utils import MMB1_reward
...
class B1GymEnv(Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.prev_cash = state['cash_B1']
        self.prev_inventory = state['inventory_B1']
    ...
    def step(self, action):
        ...
        pnl_curr = state['cash_B1'] + state['inventory_B1'] * state['price']
